...
## Extra bonus
  ...
  |:---|:-------|:------------|
  | **10** | Augmente l'intelligence d'un Héros allié de 30 (tous les Héros). | **+1500** |
  | **20** | Lorsqu'un Héros allié lance un sort de soutien, l'assassin lance Vision d'aigle, dont l'effet dure 3 secondes. Le temps de recharge est de 10 secondes. | - |
  | **30** | Augmente l'ATQ d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | Le bonus de dégâts critiques de <Rien n'est vrai> est efficace sur toutes les factions. | - |
