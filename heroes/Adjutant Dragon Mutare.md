---
title: "Adjudant Mutare (dragon)"
permalink: /heroes/Adjutant Dragon Mutare/
excerpt: "Era of Chaos  Adjudant Mutare (dragon)"
...
## Détails
 **Hero:**  [Mutare (dragon)](/fr/heroes/Dragon Mutare/) 
...
## Extra bonus
  ...
  |:---|:-------|:------------|
  | **10** | Augmente la DÉF d'un Héros allié de 30 (tous les Héros). | **+1500** |
  | **20** | <Cercle draconique> : augmente la résistance aux dégâts de 5 % supplémentaires. Cette compétence n'est pas cumulable. | - |
  | **30** | Augmente l'ATQ d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | <Cercle draconique> : efficace sur toutes les factions. | - |
