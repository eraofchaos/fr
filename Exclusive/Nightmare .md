 ...
 **Exclusif for Unit:** [Cauchemar](/units/Nightmare/) 
...
## Rang supérieur
  ...
  | **4x** <i class="fas fa-star"/> | ? | Augmente la ténacité du Cauchemar de 400. |
  | **5x** <i class="fas fa-star"/> | ? | <Dévoreur de rêves> : Lorsque <Sans trace> se déclenche, le Cauchemar diminue la résistance aux dégâts d'unité, la DÉF et la résistance magique de sa cible actuelle de 2 % pendant 6 secondes. L'effet peut se cumuler jusqu'à 10 fois. |
  | **6x** <i class="fas fa-star"/> | ? | <Traînée infernale> : <Dévoreur de rêves> affecte une colonne d'ennemis devant l'attaquant. |
