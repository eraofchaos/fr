...
## Extra bonus
  ...
  | **20** | <Maître de la guerre> : augmente les dégâts d'unité de 1 % supplémentaire toutes les 15 secondes. | - |
  | **30** | Augmente la DÉF d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | <Maître de la guerre> : efficace sur toutes les factions. | - |
