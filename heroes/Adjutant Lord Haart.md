...
## Extra bonus
  ...
  | **20** | <Aura effroyable> : augmente les dégâts d'unité de 5 % supplémentaires. | - |
  | **30** | Augmente la DÉF d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | <Aura effroyable> : augmente la résistance aux dégâts des unités de mêlée de 10 % supplémentaires. L'effet est doublé pour le Chevalier noir. | - |
