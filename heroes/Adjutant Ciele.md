...
## Extra bonus
  ...
  | **20** | <Conflux éclairé> : réduit la résistance magique des unités ennemies de 15 % supplémentaires. | - |
  | **30** | Augmente le savoir d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | <Conflux éclairé> : augmente les dégâts de sort des Héros alliés de 50 % supplémentaires. | - |
