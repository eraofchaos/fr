...
excerpt: "Era of Chaos Charge gracieuse. Charge gracieuse. Era of Chaos Exclusif Charge gracieuse. Chevaucheur de loup Exclusif."
last_modified_at: 2021-03-02
locale: fr
ref: "Wolf Rider Charge gracieuse.md"
toc: false
classes: wide
---
 ...
 **Exclusif for Unit:** [Chevaucheur de loup](/units/Wolf Rider/) 
...
## Rang supérieur
  ...
  | **4x** <i class="fas fa-star"/> | ? | Augmente l'esquive et la ténacité du Chevaucheur de loup de 60 à chaque fois qu'une unité du Bastion est déployée. |
  | **5x** <i class="fas fa-star"/> | ? | Le Chevaucheur de loup est totalement immunisé contre les dégâts de sorts pendant les 20 premières secondes de la bataille. |
  | **6x** <i class="fas fa-star"/> | ? | Chaque fois que <Pacte du loup> est lancé, un Roi des loups a 20 % de chance d'être invoqué. Une fois invoqué, le Roi des loups augmente de 20 % la vitesse d'attaque de toutes les unités du Bastion alliées pendant 10 secondes. Cet effet ne peut pas se cumuler. Les attaques du Roi des loups ont 25 % de chance d'infliger Étourdissement à la cible pendant 2 secondes et de lui infliger le double de dégâts. |
