...
## Extra bonus
  ...
  | **20** | <Bastion amélioré> : augmente le renvoi des dégâts de 5 % supplémentaires. | - |
  | **30** | Augmente l'ATQ d'un Héros allié de 40 (tous les Héros). | **+1500** |
  | **40** | <Bastion amélioré> : augmente les coups critiques de 100 points supplémentaires. L'effet est doublé pour le Rock. | - |
