...
## Extra bonus
  ...
  | **20** | <Invasion obscure> : réduit la résistance aux dégâts de 10 % supplémentaires. | - |
  | **30** | Augmente le savoir d'un Héros allié de 60 (tous les Héros). | **+1500** |
  | **40** | <Invasion obscure> : n'affecte pas les unités alliées. | - |
