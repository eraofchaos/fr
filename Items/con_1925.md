 ...
 **Required Level to open:** 1
 ...
 1 You would get **ALL** items  from:
  ...
  | 2 | [Coffre de composants d'artefact épique](/fr/Items/con_1926/) | À utiliser pour obtenir au choix : 1 coffre de composants (Vengeance), 1 coffre de composants (Fantôme), 1 coffre de composants (Roi des Non-Morts) ou 1 coffre de composants (Trésor). | 
