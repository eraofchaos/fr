 ...
 **Required Level to open:** 1
 ...
 You would need to choose 1 item from the list (0):
  ...
  | 4 | [Coffre de composants (Jugement dernier)](/fr/Items/con_1360/) | Coffre de composants de l'artefact Lame d'Armageddon. Ouvrez-le pour recevoir un des composants des trésors de la Lame d'Armageddon. | 
  | 5 | [Coffre de composants (Perturbation)](/fr/Items/con_1371/) | Coffre de composants de l'artefact Orbe de vulnérabilité. Ouvrez-le pour recevoir un des composants des trésors de l'Orbe de vulnérabilité. | 
