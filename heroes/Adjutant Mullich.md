...
## Extra bonus
  ...
  | **20** | <Au travers des lignes ennemies> : augmente la résistance aux dégâts de l'unité de 10 % supplémentaires. | - |
  | **30** | Augmente la DÉF d'un Héros allié de 40 (tous les Héros). | **+1500** |
  | **40** | <Au travers des lignes ennemies> : immunise contre Lenteur et Étourdissement. | - |
