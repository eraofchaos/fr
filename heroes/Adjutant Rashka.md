...
## Extra bonus
  ...
  | **20** | <Carnage ardent> : augmente l'effet des sorts de feu de 5 % supplémentaires. | - |
  | **30** | Augmente l'ATQ d'un Héros allié de 40 (tous les Héros). | **+1500** |
  | **40** | <Carnage ardent> : augmente la résistance à la magie de feu des unités alliées de 20 % supplémentaires. Augmente les coups critiques de l'Effrit de 20 % supplémentaires. | - |
